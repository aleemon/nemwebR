...
#'
#' Archive data is available from July 2009 to approximately two weeks ago. In order to retrieve newer data you will need to use the nemwebR_current_BIDDAYOFFER function.
#'
#'
...
#'
#' @examples
#' nemwebR_archive_biddayoffer(202101)
#'
